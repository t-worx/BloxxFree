...
<div class="siteWrapper BloxxFreeTheme sidebarPage">
	...
	<div class="contentMain sectionMain">
		<div class="siteWidth">
			<div class="col-md-9 col-md-push-3 noPad">
				...
				<div class="myPane" id="MidPane" runat="server" visible="false"></div>
			</div>
			<div class="col-md-3 col-md-pull-9 noPad">
				<div class="sideMenuMain">
					<dnn:MENU MenuStyle="menus/sidemenu" runat="server"></dnn:MENU>
				</div>
				<div class="myPane" id="SidebarPane" runat="server" visible="false"></div>
			</div>
			<div class="clearfix"></div>
